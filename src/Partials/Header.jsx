 ...
 useEffect(() => {
  ...
  return (
    ...
    ><h1 className="text-5xl font-black text-white  ">
         ...
         <p className="text-white w-[60%] mt-5 ">{wallpaper.overview.slice(0, 200)}<Link className="text-blue-200">...more</Link></p>
         ...
         <Link className="hover:text-white  text-zinc-200 font-semibold p-4 mt-2 rounded-xl bg-[#6556CD]">
         Watch Trailer
         </Link>
    </div>
    </>
